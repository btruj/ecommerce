      ...
      <section className="container mt-32 slideproduct">
        ...
        <div className="flex justify-between flex-col lg:flex-row my-10">
          ...
          <div className="lg:w-1/2 grid grid-cols-2 gap-5 lg:px-8 mt-5">
            <ProductDetailsBox title="All-in-One Car Seat" desc="One car seat that fits your child, vehicle and life from birth through booster"/>
            <ProductDetailsBox title="Space-Saving Design" desc="Slim, space-saving design takes up less space in vehicle without compromising comfort"/>
            <ProductDetailsBox title="Easiest to Install Correctly" desc="Chicco patented SuperCinch force-multiplying LATCH tightener ensures a tight and secure fit every time"/>
            <ProductDetailsBox title="No Added Chemicals" desc="ClearTex products meet federal flammability standards without added chemicals"/>
          </div>
        </div>
