        ...
        <div className="container h-full flex items-center justify-center">
            ...
            <div className="left w-1/2 relative z-50">
                ...
                <BodyOne className="mb-8">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto dignissimos labore officiis expedita laudantium saepe, quos cumque hic non doloribus, dolore sed delectus atque. Quasi vel dolor iure sint et?
                </BodyOne>
                <Slider {...settings}>
                <TestimonialsCard
                name="Kenneth Fong"
